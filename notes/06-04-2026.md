...
- [x] Identify ParaView Tutorials
    - [x] Videos
        - [ATPESC 2022](https://www.youtube.com/watch?v=MtnwvWkp6jE)
        - [ATPESC 2021](https://www.youtube.com/watch?v=jBiXFTKzz4I)
        - [ATPESC 2015](https://www.youtube.com/watch?v=aqu-hcJn9HY)
    - [x] Guides
        - [Paraview Self Guided Tutorial](https://docs.paraview.org/en/latest/Tutorials/SelfDirectedTutorial/index.html)
    - [x] Example programs
        - [ParaView Examples](https://gitlab.kitware.com/paraview/paraview/-/tree/master/Examples?ref_type=heads)
- [x] Create an updated task list to reflect the current project goal
    - See the [Task List section](#10-week-task-plan)
- [x] Update deliverables where necessary to reflect current project goal
    - See [this updated deliverable](./artifacts/week1b_deliverable.md)
    - Here is [the previous deliverable](artifacts/week1a_deliverable.md)
- [x] Condense $1 of eScience work
- [x] Identify SC workshops and SE venues to submit this work to
    - See [this ordered list of venues](#planned-venues)
- [x] Organize the lit review notes in Zotero into some Markdown/PKM accessible
      format
    - Migrated to using Obsidian (for now)

## Homework From [06-03-2026](06-03-2026.md)
...
- [x] Find ParaView tutorials to learn how to use the GUI
- [x] Look into SE workshops and conferences to submit this work to as a
      fallback
    - See [this section](#Planned%20Venues)
- [ ] Continue literature review covering existing agentic systems
...
> This plan has been modified from [05-28-2026](./05-27-2026.md). It is also
> copied to [Task List](Task%20List.md)
...
## Literature Review Color Coding System
...
Wrote up the formal "Project Overview and Change in Directions" memo: of the
four candidate directions on the table after 06-01 (continue multi-agent,
ParaView agentic tooling, IDEAS provenance/logging, user study), the choice is
option 2 — improving agentic ParaView tooling with NL2SciViz and
SciVizAgentBench as the targets and exploring RAG variants (full ParaView docs,
mailing list, issues) and additional tool integrations (web search, LSPs) on top
of the ChatVis/ParaView-MCP baseline. Reissued the 10-week plan as
`week1b_deliverable.md` (supersedes `week1a`) with weeks 1–3 rewritten to
reflect the new direction (weeks 4–10 carried over unchanged, flagged for later
revision). Re-ordered the venue list to prioritize Learning-on-the-Lawn, SC
Poster, AgenticAI4HPC, AI4S, ICSE 2027, WORKS, AI-on-HPC. Collected ParaView
learning resources (ATPESC 2015/2021/2022 talks, the self-guided tutorial, the
Kitware examples tree), migrated literature notes to Obsidian, and defined a
seven-tag color-coded review scheme. eScience paper trimmed to 8 pages with
methodology checked.

### How This Builds on [06-03-2026](06-03-2026.md)

Formalizes the scope decisions that 06-01 introduced, 06-02 committed to, and
06-03 narrowed into a research framing — they are now written down in the
project charter and the `week1b` deliverable. The "prompt vs. context" question
from 06-03 is restated as concrete tooling alternatives (full-doc RAG, MCP
variants, LSP/web-search-augmented agents) measured against NL2SciViz and
SciVizAgentBench. The ParaView learning resources backfill a gap exposed once
06-03 unblocked the MCP server: now that the tool runs, the user actually needs
to know how to drive ParaView.
